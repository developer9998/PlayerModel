...
{
    public class GorillaIndependentIK : MonoBehaviour
    {
        ...
        {
            ArmIK(ref leftUpperArm, ref leftLowerArm, ref leftHand, initialUpperLeft, initialLowerLeft, targetLeft, true);
            ArmIK(ref rightUpperArm, ref rightLowerArm, ref rightHand, initialUpperRight, initialLowerRight, targetRight, false);
        }

        private void ArmIK(ref Transform upperArm, ref Transform lowerArm, ref Transform hand, Quaternion initRotUpper, Quaternion initRotLower, Transform target, bool isLeftHand)
        {
